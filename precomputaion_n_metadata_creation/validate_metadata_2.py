...
base_directory = "E:/Project_Experiments/only_dolphin_experiment/separated_augmented/validate_data"


output_file = os.path.join(base_directory, "validate_metadata.xlsx")
