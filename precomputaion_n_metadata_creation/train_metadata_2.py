...
base_directory = "E:/Project_Experiments/only_dolphin_experiment/separated_augmented/train_data"

output_file = os.path.join(base_directory, "train_metadata.xlsx")
